...
write_brand_and_price_file('s4-brand_and_price.csv', gucci_ties)
...
write_min_max_csv('s4-min_max.csv', gucci_ties[1:])
...
write_two_cols('s4-write_two_cols.csv', gucci_ties[1:], 3, 7)
